...
const {getAllEvents,getEventById,createEvent,updateEvent, deleteEvent, getEventsByDate , EventWithCreator , addParticipant, getParticipatedEvents} = require("../controllers/events");
