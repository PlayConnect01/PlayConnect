...
const getStyles = (isSidebarVisible) =>
  StyleSheet.create({
    safeArea: {
      flex: 1,
...
const Marketplace = () => {
  ...
  const fetchCartCount = useCallback(async () => {
    try {
      ...
      setNotification({
        message: "Failed to load cart count. Please try again.",
        type: "error",
      });
    }
  }, []);
                  ...
                  <View style={styles.cardContentOverlay}>
                    ...
                    <View style={styles.cardRatingContainer}>
                      {[1, 2, 3, 4, 5].map((star) => (
                        <FontAwesome
                          key={star}
                          name={
                            star <= currentProduct.rating ? "star" : "star-o"
                          }
                          size={20}
                          color={
                    ...
                    <View style={styles.cardActions}>
                      ...
                      >
                        <FontAwesome
                          name={
                            favoriteProducts.includes(currentProduct.product_id)
                              ? "heart"
                              : "heart-o"
                          }
                          size={24}
                    ...
                    navigation.navigate("ProductDetail", {
                      ...
                      product: {
                        ...
                        description:
                          ...
                          "Experience premium quality and exceptional value with this exclusive offer.",
                  ...
                  <View style={styles.discountInfo}>
                    ...
                    <View style={styles.discountFeatures}>
                      <View style={styles.discountFeature}>
                        <Text style={styles.discountFeatureText}>
                          Free Shipping
                        </Text>
                      </View>
                      <View style={styles.discountFeature}>
                  ...
                  <TouchableOpacity
                    style={[
                      ...
                      addingToCartId === discount.product_id &&
                        styles.discountCartButtonSuccess,
                    ]}
