...
const YogaProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Yoga products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Yoga Equipment</Text>
          <Text style={styles.headerTitle}>Professional Yoga Gear</Text>
          <Text style={styles.headerSubtitle}>
            Find your balance with premium yoga equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="yoga" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1545205597-3d9d02c29597?ixlib=rb-4.0.3' }}
