...
const SPORT_ID = 2; // Basketball ID
...
const  BasketballProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Basketball products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Basketball Equipment</Text>
          <Text style={styles.headerTitle}>Professional Basketball Gear</Text>
          <Text style={styles.headerSubtitle}>
            Elevate your game with premium basketball equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="sports-basketball" size={18} color="#FFFFFF" style={styles.statIcon} />
