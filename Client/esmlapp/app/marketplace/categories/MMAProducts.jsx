...
const  MMAProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching MMA products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>MMA Equipment</Text>
          <Text style={styles.headerTitle}>Professional MMA Gear</Text>
          <Text style={styles.headerSubtitle}>
            Dominate the octagon with premium MMA equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="karate" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1555597673-b21d5c935865?ixlib=rb-4.0.3' }}
