    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Gym Equipment</Text>
          <Text style={styles.headerTitle}>Professional Fitness Gear</Text>
          <Text style={styles.headerSubtitle}>
            Transform your workout with premium gym equipment
          </Text>
