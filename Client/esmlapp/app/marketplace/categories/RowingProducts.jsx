...
const RowingProducts = () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Rowing products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Rowing Equipment</Text>
          <Text style={styles.headerTitle}>Professional Rowing Gear</Text>
          <Text style={styles.headerSubtitle}>
            Master the water with premium rowing equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="rowing" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1540320865252-e4abf9e80004?ixlib=rb-4.0.3' }}
