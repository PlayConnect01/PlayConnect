...
const  FootballProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Football products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Football Equipment</Text>
          <Text style={styles.headerTitle}>Professional Football Gear</Text>
          <Text style={styles.headerSubtitle}>
            Score big with premium football equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="sports-football" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1552667466-07770ae110d0?ixlib=rb-4.0.3' }}
