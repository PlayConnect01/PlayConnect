...
const SwimmingProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Swimming products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Swimming Equipment</Text>
          <Text style={styles.headerTitle}>Professional Swimming Gear</Text>
          <Text style={styles.headerSubtitle}>
            Make waves with premium swimming equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="swim" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?ixlib=rb-4.0.3' }}
...
export default SwimmingProducts;
