...
const SPORT_ID = 2; // Volleyball ID
...
const VolleyballProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Volleyball products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Volleyball Equipment</Text>
          <Text style={styles.headerTitle}>Professional Volleyball Gear</Text>
          <Text style={styles.headerSubtitle}>
            Spike your performance with premium volleyball equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="sports-volleyball" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1592656094267-764a45160876?ixlib=rb-4.0.3' }}
