...
const SkatingProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Skating products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Skating Equipment</Text>
          <Text style={styles.headerTitle}>Professional Skating Gear</Text>
          <Text style={styles.headerSubtitle}>
            Roll with style using premium skating equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialCommunityIcons name="skateboard" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1564982752979-3f7bc974d29a?ixlib=rb-4.0.3' }}
...
export default SkatingProducts;
