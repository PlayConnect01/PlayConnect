  ...
  const ESportsProducts= () => {
    ...
    const loadProducts = async () => {
      try {
        setLoading(true);
        console.log('Fetching ESports products');
      ...
      <View style={styles.headerContainer}>
        <View style={styles.headerContent}>
          <View style={styles.headerLeft}>
            <Text style={styles.headerCategory}>ESports Equipment</Text>
            <Text style={styles.headerTitle}>Professional Gaming Gear</Text>
            <Text style={styles.headerSubtitle}>
              Level up your game with premium esports equipment
            </Text>
            <View style={styles.headerStats}>
              <View style={styles.statItem}>
                <MaterialCommunityIcons name="gamepad-variant" size={18} color="#FFFFFF" style={styles.statIcon} />
          ...
          <View style={styles.headerImageContainer}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?ixlib=rb-4.0.3' }}
  ...
  export default ESportsProducts;
