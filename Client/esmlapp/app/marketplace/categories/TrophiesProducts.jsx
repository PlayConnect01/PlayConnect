...
const TrophiesProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Trophies products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Trophies & Awards</Text>
          <Text style={styles.headerTitle}>Professional Trophy Collection</Text>
          <Text style={styles.headerSubtitle}>
            Celebrate success with premium trophies and awards
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="emoji-events" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1587582345426-bf07f534b063?ixlib=rb-4.0.3' }}
