...
const  HockeyProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Hockey products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Hockey Equipment</Text>
          <Text style={styles.headerTitle}>Professional Hockey Gear</Text>
          <Text style={styles.headerSubtitle}>
            Dominate the ice with premium hockey equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="sports-hockey" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1580673787750-2c5ef81775ff?ixlib=rb-4.0.3' }}
