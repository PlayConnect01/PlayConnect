...
const WalkingProducts= () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Walking products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Walking & Hiking Equipment</Text>
          <Text style={styles.headerTitle}>Professional Walking Gear</Text>
          <Text style={styles.headerSubtitle}>
            Step into adventure with premium walking equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="directions-walk" size={18} color="#FFFFFF" style={styles.statIcon} />
