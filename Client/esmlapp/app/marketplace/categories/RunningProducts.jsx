...
const RunningProducts = () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Running products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Running Equipment</Text>
          <Text style={styles.headerTitle}>Professional Running Gear</Text>
          <Text style={styles.headerSubtitle}>
            Go the distance with premium running equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="directions-run" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1595432541891-a461100d3054?ixlib=rb-4.0.3' }}
