...
const CricketProducts = () => {
  ...
  const loadProducts = async () => {
    try {
      setLoading(true);
      console.log('Fetching Cricket products');
    ...
    <View style={styles.headerContainer}>
      <View style={styles.headerContent}>
        <View style={styles.headerLeft}>
          <Text style={styles.headerCategory}>Cricket Equipment</Text>
          <Text style={styles.headerTitle}>Professional Cricket Gear</Text>
          <Text style={styles.headerSubtitle}>
            Elevate your game with premium cricket equipment
          </Text>
          <View style={styles.headerStats}>
            <View style={styles.statItem}>
              <MaterialIcons name="sports-cricket" size={18} color="#FFFFFF" style={styles.statIcon} />
        ...
        <View style={styles.headerImageContainer}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?ixlib=rb-4.0.3' }}
